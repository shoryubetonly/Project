 ...
 * คืนค่า: public URL (เช่น /lafs/uploads/2025/10/xxxx.jpg) หรือ null ถ้าไม่เลือกไฟล์
 */
function upload_image(
    string $field_name,
    int $maxBytes = 2097152, // 2MB
    string $uploadsBasePublic = '/lafs/uploads',
...
function avatar_fallback(): string {
    return '/lafs/assets/img/account_circle.png';
}
