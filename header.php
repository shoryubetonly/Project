...
<header class="site-header">
  <div class="container header-inner">
    ...
    <nav class="nav">
      <a href="/lafs/index.php">หน้าแรก</a>
      <a href="/lafs/create.php" class="btn">โพสต์ประกาศ</a>
      ...
      $role_label   = '';
      $avatar_url   = function_exists('avatar_fallback') ? avatar_fallback() : '/lafs/assets/img/account_circle.png';
        ...
        try {
          ...
          if ($aid > 0) {
            ...
            if (function_exists('avatar_url')) {
              ...
              $avatar_url = trim((string)$avatar_db) !== '' ? $avatar_db : '/lafs/assets/img/account_circle.png';
            }
          }
        } catch (Throwable $e) {
      ...
      <?php if ($isSigned): ?>
        <a href="/lafs/admin_posts.php" class="btn-secondary" style="margin-left:8px;">จัดการโพสต์</a>
          ...
          <div class="dropdown">
            ...
            <div class="menu">
              <?php if (($_SESSION['admin']['role'] ?? '') === 'root'): ?>
                <a href="/lafs/admin_users.php">ผู้ดูแลระบบทั้งหมด</a>
                <a href="/lafs/admin_user_new.php">+ เพิ่มแอดมิน</a>
              <?php else: ?>
                <a href="/lafs/admin_user_edit.php?id=<?= (int)($_SESSION['admin']['id'] ?? 0) ?>">โปรไฟล์ของฉัน</a>
              <?php endif; ?>

              <form action="/lafs/admin_logout.php" method="post" style="margin-top:6px;">
      ...
      <?php else: ?>
        <a href="/lafs/admin_login.php" class="btn-secondary" style="margin-left:8px;">เข้าสู่ระบบผู้ดูแล</a>
      <?php endif; ?>
    </nav>
  </div>
</header>
