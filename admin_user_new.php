...
/**
 * อัปโหลดรูปโปรไฟล์ไปไว้ที่ /lafs/uploads/avatars/
 * คืนค่า URL แบบ absolute path เช่น: /lafs/uploads/avatars/xxxx.webp
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($username === '' || $pass1 === '' || $pass2 === '') {
    ...
    redirect('/lafs/admin_user_new.php');
  }
  ...
  redirect('/lafs/admin_users.php'); // หน้า list ผู้ดูแล (สำหรับ root)
}
...
<section class="section">
  <div class="form" style="max-width:560px;margin:0 auto;">
    ...
    <form method="post" action="/lafs/admin_user_new.php" autocomplete="off" enctype="multipart/form-data">
