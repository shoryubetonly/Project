...
<section class="section">
  <div class="form" style="max-width:480px;margin:0 auto;">
    ...
    <form method="post" action="/lafs/admin_login.php" autocomplete="off">
      ...
      <div class="actions">
        ...
        <a class="btn btn-secondary" href="/lafs/">ยกเลิก</a>
      </div>
      ...
      <p class="muted" style="margin-top:4px;color:var(--muted);font-size:13px;">
        ถ้ายังไม่เคยตั้งค่าผู้ดูแล <a href="/lafs/admin_seed.php">สร้างผู้ดูแลคนแรก</a>
      </p>
    </form>
  </div>
</section>
